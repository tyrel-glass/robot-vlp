...
The overarching model architecture was a sequence to vector RNN, with input shape (windowlen, 5).
This meant the input of the model was an array that contained odometer and vlp estimates for the current location, back to n steps in the past. 
